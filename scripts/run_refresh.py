...
def run_once(mode: str) -> None:
    ...
    # them on the Dashboard for the tracking user; company_type (migration
    # 0018, formerly the is_etf boolean from 0015) is what actually
    # excludes real ETFs/funds from that list.
    ...
    if portfolio_rows:
        ...
        if new_companies:
            ...
            # failed lookup just leaves company_type at its Equity default
